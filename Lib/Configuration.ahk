...
setupDefaultDA(Path) {
    str=
        (LTRIM
            ...
            `tauthor:combobox|Type:String|Default:"Gewerd Strauss"|String:"Set Author for this output format"|ctrlOptions:Claudius Appel,Gewerd Strauss,redacted|Tab3Parent:3. Misc
    ...
    str2=
        (LTRIM
            ...
            `tauthor:combobox|Type:String|Default:"Claudius Appel"|String:"Set Author for this output format"|ctrlOptions:Claudius Appel,Gewerd Strauss,redacted|Tab3Parent:3. General
            `trenderingpackage_start:Meta|Value:quarto::quarto_render("index.qmd",execute_params = list(
